...
{
    protected $permissionCreate = 'Groups.Settings.Create';
    protected $permissionDelete = 'Groups.Settings.Delete';
    protected $permissionEdit   = 'Groups.Settings.Edit';
    protected $permissionView   = 'Groups.Settings.View';
	...
	public function index($offset = 0)
	{
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/settings/groups/index') . '/';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_groups()) {
				...
				redirect(SITE_AREA . '/settings/groups');
			}
