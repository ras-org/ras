...
{
    protected $permissionCreate = 'Groups.Reports.Create';
    protected $permissionDelete = 'Groups.Reports.Delete';
    protected $permissionEdit   = 'Groups.Reports.Edit';
    protected $permissionView   = 'Groups.Reports.View';
	...
	public function index($offset = 0)
	{
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/reports/groups/index') . '/';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_groups()) {
				...
				redirect(SITE_AREA . '/reports/groups');
			}
