...
$num_columns	= 24;
$can_delete	= $this->auth->has_permission('Groups.Settings.Delete');
$can_edit		= $this->auth->has_permission('Groups.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/groups/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->group_name); ?></td>
				<?php else : ?>
