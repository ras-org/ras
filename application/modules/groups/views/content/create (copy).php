		...
		<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
			...
			<div class="form-group<?php echo form_error('group_name') ? ' error' : ''; ?>">
				<?php echo form_label('Group Name'. lang('bf_form_label_required'), 'group_name', array('class' => 'col-sm-2 control-label')); ?>
                                    ...
                                    <div class="col-sm-10">
					<input class="form-control" id='group_name' type='text' required='required' name='group_name' maxlength='250' value="<?php echo set_value('group_name', isset($groups->group_name) ? $groups->group_name : ''); ?>" />
			...
			<div class="form-group<?php echo form_error('group_name') ? ' error' : ''; ?>">
				...
				<div class="col-sm-10">
					<input class="<?php echo $controlClass; ?>" id='group_name' type='text' required='required' name='group_name' maxlength='250' value="<?php echo set_value('group_name', isset($groups->group_name) ? $groups->group_name : ''); ?>" />
					<span class='help-inline'><?php echo form_error('group_name'); ?></span>
				</div>
			</div>
			...
			<?php // Change the values in this array to populate your dropdown as required
				...
				echo form_dropdown(array('name' => 'group_type', 'required' => 'required'), $group_type_options, set_value('group_type', isset($groups->group_type) ? $groups->group_type : ''), 'Group Type'. lang('bf_form_label_required'), 'class="span4 chzn-select"');
			?>
			...
			<div class="control-group<?php echo form_error('password') ? $errorClass : ''; ?>">
			    <label class="control-label<?php echo $registerClass; ?>" for="password"><?php echo lang('bf_password'). lang('bf_form_label_required'); ?></label>
			    <div class="controls">
			...
			<div class="control-group<?php echo form_error('pass_confirm') ? $errorClass : ''; ?>">
			    <label class="control-label<?php echo $registerClass; ?>" for="pass_confirm"><?php echo lang('bf_password_confirm'). lang('bf_form_label_required'); ?></label>
			    <div class="controls">
			...
			<div class="control-group<?php echo form_error('city') ? ' error' : ''; ?>">
				...
				<?php echo form_label('District'. lang('bf_form_label_required'), 'district', array('class' => 'control-label')); ?>
				<div class='controls'>
